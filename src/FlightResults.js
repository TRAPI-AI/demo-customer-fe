...
# The refactored code includes state management for input fields, integrates with the backend API, and displays flight offers. A loading indicator is also added.