...
// The above code refactors the frontend components to integrate with the backend API, allowing users to search for flights and view results. The `FlightSearch` component handles user input and API requests, while `FlightResults` displays the flight offers returned from the API.