...
// The refactored code includes a loading indicator and maps the request and response data to the frontend fields. The FlightSearch component handles the API call and passes the data to FlightResults for display.