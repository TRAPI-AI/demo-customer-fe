    ...
    <div>
      ...
      {isModalOpen && selectedOffer && (
        <div className="select-modal">
          <p className="total-emissions">Emissions: {selectedOffer.total_emissions_kg}</p>
          <p className="destination-type">Tax Amount: {selectedOffer.tax_amount}</p>
          <p className="corporate-code">Code: {selectedOffer.slices[0].segments[0].operating_carrier.iata_code}</p>
