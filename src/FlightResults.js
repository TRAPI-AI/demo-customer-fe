...
// The above code integrates the frontend with the backend API to fetch flight offers based on user input. The `FlightSearch` component handles user input and sends a request to the backend, while the `FlightResults` component displays the results.