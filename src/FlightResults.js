...
These changes ensure that the frontend correctly sends a request to the backend with the necessary data and displays the response data in the UI. The `FlightSearch` component handles the input and search logic, while the `FlightResults` component displays the flight offers.