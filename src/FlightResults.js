...
// The above code refactors the FlightSearch and FlightResults components to integrate with the backend API. It maps the request and response data to the frontend fields and handles the API call to fetch flight offers.