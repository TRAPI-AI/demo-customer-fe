      ...
      {isModalOpen && selectedOffer && (
        <div className="select-modal">
          <p className="total-emissions">
            Emissions: {selectedOffer.total_emissions_kg} kg
          </p>
          <p className="destination-type">
            Tax Amount: {selectedOffer.tax_amount} {selectedOffer.tax_currency}
          </p>
          <p className="corporate-code">
            Code: {selectedOffer.private_fares[0]?.corporate_code || "N/A"}
          </p>
...
These changes ensure that the frontend is properly integrated with the backend API, and the data is mapped correctly to the UI components. The loading indicator is also added to provide feedback during the API call.