...
These changes ensure that the frontend is properly sending requests to the backend and displaying the response data. The `FlightSearch` component handles the search logic and passes the flight offers to the `FlightResults` component, which displays them.