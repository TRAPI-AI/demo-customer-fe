            ...
            <li key={offer.vehicle.identifier} className="search-response-item">
              ...
              <div>
                ...
                <p className="price-per-day">
                  Price-per-day: {offer.price.cost_per_day} {offer.price.currency}
                </p>
                <p className="total-price">
                  Total price: {offer.price.total_cost} <span className="currency">{offer.price.currency}</span>
                </p>
              </div>
              <button className="select-button" onClick={() => setOfferInfo(offer)}>
                Select
              </button>
            </li>
          ))}
