...
// The above code refactors the frontend to integrate with the backend API, allowing users to search for hotel availability based on input criteria. It includes a loading indicator and dynamically maps the API response to the UI.